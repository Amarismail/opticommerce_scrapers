...
def start():
    ...
    in_master_json_file_path, in_master_json_backup_file, all_scraper_run_details = setup_folder(in_master_json_filename)
    setup_logging()
    ...
    for prod_category, in_myproduct_urls in in_myproduct_urls_dict.items():
        try:
            ...
            for in_product_url in in_myproduct_urls:
                ...
                in_product_url = 'https://www.prodesigndenmark.com/optical/essential/strike/strike-4868/?colorCode=9535'
