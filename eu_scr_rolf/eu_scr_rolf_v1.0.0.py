...
def get_prod_urls(session, context, category_name, category_link, in_myproduct_urls, page_num = 1):
    ...
    if not prod_url_tags and page_num == 1:
        ...
        with open('html_out_test_1.html', 'w', encoding='utf-8') as f:
...
def get_prod_final_image(json_obj, variant_img_url):
    ...
    is_external_link, variant_img_url = normalize_url(constants.website_url, variant_img_url)
...
def map_variants_info_tags(variant_url_tags, prod_variant_colors):
    ...
    variant_url_tags = list(set(variant_url_tags))
...
def start():
    ...
    categories_dict = {'brillen': 'https://shop.rolf-spectacles.com/de/c/brillen'}
