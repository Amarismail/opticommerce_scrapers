...
website_prod_store_url = constants.website_url + '/collections/all-eyewear'
website_prod_store_url_navigation = True
prod_store_api_base_url = constants.website_url + '/collections/all-eyewear'
...
imbedded_variants_json_data = True
