...
def visit_browser_page(context, category_link):
...
def browser_login_to_website(page, session):
    ...
    # page.fill(constants.login_email_selector, constants.user_name)
    # page.fill(constants.login_pass_selector, constants.password)
    # page.press(constants.login_pass_selector, "Enter")

    delay(2000)
    session = set_cookies(page, session)
